...
react-cookie는 useCookie 훅을 통해 
  쿠키(cookies), 쿠키설정함수(setCookie), 쿠키제거함수
  (removeCookie)를 반환 
  ...
  */
  ...
  return (
    <div>
      ...
      <button onClick={handleRemoveClickCookie}>쿠키 제거 버튼</button>
